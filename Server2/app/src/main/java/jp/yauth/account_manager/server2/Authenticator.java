...
public class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Authenticator(Context context) {
        super(context);
        mContext = context;
        mAccountType = mContext.getString(jp.yauth.account_manager.server2.R.string.authenticator_type);
    }
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        String authToken = String.format("access_token for scope=\"%s\" (Server2)", authTokenType);
        ...
        result.putString("id_token", "header.payload.signature (Server2)");
        return result;
    }
